...
def parse_config():
    ...
    # Signal Target
    parser.add_argument("--opt_transmittance", type=float, default=0.75, help='Transmittance of the entire optical system from 0 to 1')
    ...
    parser.add_argument("--epsilon", type=float, default=0.97, help='Fraction of optical aperture area obscured')
    ...
    parser.add_argument("--spectral_res", type=float, default=2, help='spectral resolution (nm) between 0.5nm and 8.5nm')
